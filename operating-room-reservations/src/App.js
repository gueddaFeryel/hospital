    ...
    return (
        <Routes>
            ...
            <Route element={<ProtectedLayout />}>
                ...
                <Route
                    path="/"
                    element={<Navigate to={userData?.role === 'admin' ? "/dashboard" : "/home"} replace />}
                />
                ...
                {userData?.role === 'admin' && (
                    <>
                        ...
                        <Route path="/salles/create" element={<CreateRoomForm />} />
                        <Route path="/salles/edit/:id" element={<EditRoomForm />} />
            ...
            <Route
                path="*"
                element={<Navigate to={currentUser ? (userData?.role === 'admin' ? "/dashboard" : "/home") : "/login"} replace />}
            />
        </Routes>
    );
}
